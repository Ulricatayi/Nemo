  ...
  async execute(senderId, args, pageAccessToken, event, imageUrl) {
    ...
    try {
      ...
      const useImageRecognition =
        imageUrl || 
        ["recognize", "analyze", "analyst", "answer", "analysis", "traite", "analyse", "répond"].some(term => userPrompt.includes(term)); 
      ...
      const responseTime = new Date().toLocaleString('en-US', { timeZone: 'Africa/Porto-Novo', hour12: false });
